...
<td width=100 align="center"><img src = "tourismMinister.jpg" height=50 width=100 style ="border-radius: 50%"><a href = "#"><font size=2>श्री प्रहलाद सिंग पटेल <br>मान.  पर्यटन मंत्री </a></font></td>
    ...
    <div class="topnav">
      ...
      <a href="Viewplace.asp" style ="background-color: #1abc9c ; border-radius : 8px;">View Place </a>
	...
	<div>
	  ...
	  <i style = "color:white;float:left;word-spacing:20px;font-size:15px"> <% response.Write( ucase(Session("adminname")))%></i>
		  ...
		  <div align="center">
<form method = "post" action ="searchPlace.asp">
Place Name <select name = "place">
<option>Select..</option>
<% do until rs.EOF
%>
<option value = "<%=rs("pname")%>"><%=rs("pname")%></option><%rs.MoveNext
loop 
rs.close
set rs = Nothing
...
<caption style ="font-size:40px;color:white;font-family:cambria;text-decoration:underline">Place List</caption>
<br>
<br>
<tr>
<th>Place Name</th>
...
<td><%=rss("plocation")%></td>
<td><%=rss("ptags")%></td>
<td><img src = <%=rss("pimage")%> style="width:230px;height:100px;border-radius:1px;"> </td>
</tr>
<%
rss.MoveNext
loop
