...
<img src = us.png class = "usr"><br><br><center>Admin</center><br>
<form  method="post" id="register" action="AdminRegiRedirect.asp">
Admin NAME:<input type="text" name = "uname" placeholder="Enter User name" ><br>
